...
class MegatronBaseModel(NLPModel):
    ...
    def build_transformer_config(self) -> TransformerConfig:
        ...
        gated_linear_unit = activation.endswith('glu') # Srijith: https://github.com/NVIDIA/NeMo/pull/8042/files
        ...
        config_mapping = {
            ...
            'gated_linear_unit': gated_linear_unit, #Srijit: https://github.com/NVIDIA/NeMo/pull/8042/files
