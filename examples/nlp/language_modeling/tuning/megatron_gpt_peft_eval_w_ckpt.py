...
@hydra_runner(config_path="conf", config_name="megatron_gpt_peft_eval_w_ckpt")
def main(cfg) -> None:
    ...
    if cfg.model.peft.restore_from_path:
        ...
        conf , _ = model._get_config_and_state_dict_from_nemo(cfg.model.peft.restore_from_path, map_location)
        peft_cfgs = LoraPEFTConfig(conf)
        model.load_adapters(cfg.model.peft.restore_from_ckpt_name, peft_cfgs) # Srijith  added model_cfg and made it restore_from_ckpt_name  instead restore_from_path
